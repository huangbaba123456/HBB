...
//////////////////////////////////////////////////////////////////////
/// 验证对方证书
void HBBSSLCtx::SetVerify(const char *ca_crt)
{
...
bool  HBBSSLCtx::InitClient(const char *ca_file )
{
...
bool HBBSSLCtx::InitServer(const char*crt_file, const char *key_file, const char *ca_file )
{
    //创建服务器 ssl ctx上下文
...
HBBSSL HBBSSLCtx::NewHBBSSL(int socket)
{
    HBBSSL xssl;
    if (!ssl_ctx_)
    {
